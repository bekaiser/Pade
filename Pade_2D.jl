...
# =============================================================================
# finite difference operator and boundary conditions

N = 100 # number of grid points

# dynamical operator and b matrix
...
function advection(q,u,v,Ax,bx) # 4th-order Pade scheme derivatives (free-slip)
	# zonal derivatives
...
N = 200 # series length (must be at least even)
@show(N)
...
# boundary conditions:
bc = 1 # 1 for no-slip, 2 for free-slip
# check if the velocity computations for no-slip are correct!
...
JA = dxpsiA.*dqdyA-dypsiA.*dqdxA
@show(maximum(JA))
# force this to zero for no-slip?
